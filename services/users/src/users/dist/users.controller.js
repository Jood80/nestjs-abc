...
var UsersController = /** @class */ (function () {
    ...
    UsersController.prototype.getUserById = function (id) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.userService.user({ id: Number(id) })];
            });
        });
    };
    UsersController.prototype.signupUser = function (userData) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
    ...
    UsersController.prototype.deleteUser = function (id) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.userService.deleteUser({ id: Number(id) })];
            });
        });
    };
    __decorate([
    ...
    ], UsersController.prototype, "signupUser");
    __decorate([
